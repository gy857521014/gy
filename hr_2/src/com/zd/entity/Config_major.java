...
public class Config_major {
	...
	private int major_kind_id;//职位分类编号(外健：Config_major_kind 表中的：major_kind_id)
	...
	public Config_major(int mak_id, int major_kind_id, String major_kind_name, int major_id, String major_name,
			int test_amount) {
		super();
		this.mak_id = mak_id;
		this.major_kind_id = major_kind_id;
