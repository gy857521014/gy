...
<body>
	<form method="post"
		action="/HR_Fist/salaryCriterion/salaryCriterionAction!initSalaryStandardCheckList.action">
		<table width="100%">
			<tr>
...
<body>
	<p>
		<div align="center" style="font-size: 18px; color: gray">
			&nbsp;&nbsp;总数： <font style="color: maroon;font-weight: bold;">12</font>
			例 &nbsp;&nbsp;&nbsp; 每页显示 <font
				style="color: maroon;font-weight: bold;">10</font> 条
			&nbsp;&nbsp;&nbsp; 当前第 <font style="color: maroon;font-weight: bold;">1</font>
			页 &nbsp;&nbsp;&nbsp;共 <font style="color: maroon;font-weight: bold;">2</font>
			...
			<a style="color: navy; font-weight: bold" href="javascript:doPage(2)">末页</a>
