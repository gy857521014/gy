				...
				<tr>
					<td width="65%">
						...
						<input type="file" class="FILE_STYLE1" name="accFile"
							width="100%">
						<input type="hidden" name="humanFile.humanId" value="bt201211190646190086"/>
					</td>
					<td width="41%" align="right">
						<input type="button" value="上传图片" class="BUTTON_STYLE1" onclick="location.href='register_choose_picture.html'"/>
